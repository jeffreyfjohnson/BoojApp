...
public class DetailPictureDownloadService extends IntentService {

    public static final String EXTRA_PIC_POSITION = "com.jeffjohnson.pic_position";
    public static final String INTENT_DETAIL_PIC = "com.jeffjohnson.detail_pic";

    public DetailPictureDownloadService() {
        super("DetailPictureDownloadService");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Intent broadcastDownload = new Intent(INTENT_DETAIL_PIC);
